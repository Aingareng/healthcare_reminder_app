...
import { closeIcon, humIcon, morningIcon, storageIcon, tempIcon } from '../../assets'

interface IPropsReminderBox1 {
  humidity: number,
  temperature: number,
  stock: number
  morningCheck: string
...
const ReminderBox1: React.FC<IPropsReminderBox1> = ({ humidity, stock, temperature, morningCheck }) => {


  return (
    <Fragment>
      <section className='xl:w-[260px] xl:h-[280px] relative bg-sky-300 xl:box-border xl:rounded-md xl:shadow-md '>
        <h1 className='xl:font-semibold xl:p-[10px] xl:text-md'>Medication reminder 1x1</h1>
